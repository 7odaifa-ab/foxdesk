...
$reports_controller = read_report_rate_file($root, 'includes/modules/reports/report-page-controller.php');
$reports_page = $reports_controller
    . "\n" . read_report_rate_file($root, 'includes/modules/reports/views/rates.php')
    . "\n" . read_report_rate_file($root, 'includes/modules/reports/views/billing.php');
...
assert_report_rates(str_contains($reports_controller, 'report_filter_state_from_request($request, is_admin())'), 'Reports controller must use shared report filter state.');
