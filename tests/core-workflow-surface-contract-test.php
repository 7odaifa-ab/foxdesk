...
$assert(!str_contains($client, '<style>'), 'Client workflow page must not carry local style blocks.');
...
$assert(!is_file($root . '/pages/billing.php'), 'Self-hosted edition must not ship the SaaS billing workflow page.');
