...
<link rel="stylesheet" href="assets/css/new-ticket.css?v=<?php echo defined('APP_VERSION') ? APP_VERSION : '1'; ?>">

<?php require BASE_PATH . '/includes/components/new-ticket-assets.php'; ?>
